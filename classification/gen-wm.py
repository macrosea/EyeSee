...
org_img_dir = "/Users/macrosea/tmp/photo_0803"

def scan_and_statistic00(img_dir, expect_v, desc):
...
def scan_and_statistic(img_dir, expect_v, desc):
    ...
    saved_dir = "/tmp/extract_wm"
    # if os.path.exists(saved_dir):
    #     shutil.rmtree(saved_dir)
    # os.makedirs(saved_dir)
    os.system(path_exe + " extract " + img_dir + " " + saved_dir)

def scan_and_embed(img_dir, outDir):
    os.system(path_exe + " embed " + img_dir + " " + outDir)

def no_wm():
    scan_and_statistic(org_img_dir, 0, "non")
